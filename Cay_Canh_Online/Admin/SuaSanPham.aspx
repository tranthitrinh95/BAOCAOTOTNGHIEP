...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="form-horizontal">
        ...
        <asp:Label ID="Label2" runat="server" CssClass="control-label col-md-2" Text="Tên Hoa Kiểng: "></asp:Label>
            <div class="col-md-10">
                <asp:TextBox ID="txtTenSP" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTenSP" ErrorMessage="Vui lòng nhập tên hoa !">(*)</asp:RequiredFieldValidator>
            </div>
        </div>
        <div class="form-group">
        <asp:Label ID="Label3" runat="server" CssClass="control-label col-md-2" Text="Loại Hoa Kiểng: "></asp:Label>
            <div class="col-md-10">
                <asp:DropDownList ID="ddlLoaiSP" runat="server"></asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlLoaiSP" ErrorMessage="Vui lòng nhập loại hoa !">(*)</asp:RequiredFieldValidator>
...
<div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
        <asp:Label ID="Label1" runat="server" CssClass="control-label col-md-2" Text="Mô Tả: "></asp:Label>
            <div class="col-md-10">
                <CKEditor:CKEditorControl ID="ckeMoTa" runat="server"></CKEditor:CKEditorControl>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ckeMoTa" ErrorMessage="Vui lòng nhập chi tiết !">(*)</asp:RequiredFieldValidator>
            </div>
        </div>
        <div class="form-group">
