...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <CKEditor:CKEditorControl ID="ckeNoiDung" runat="server" HtmlEncodeOutput="true" AutoParagraph="False" BasicEntities="True" EntitiesLatin="False"></CKEditor:CKEditorControl>
