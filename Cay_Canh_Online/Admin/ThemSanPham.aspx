...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="form-horizontal">
        ...
        <asp:Label ID="Label2" runat="server" CssClass="control-label col-md-2" Text="Tên Hoa: "></asp:Label>
            <div class="col-md-10">
        ...
        <asp:Label ID="Label3" runat="server" CssClass="control-label col-md-2" Text="Loại Hoa Kiểng: "></asp:Label>
            <div class="col-md-10">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlNSX" ErrorMessage="Vui lòng chọn loại hoa kiểng!">(*)</asp:RequiredFieldValidator>
...
<div class="form-group">
        ...
        <asp:Label ID="Label1" runat="server" CssClass="control-label col-md-2" Text="Mô tả: "></asp:Label>
            <div class="col-md-10">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ckeMoTa" ErrorMessage="Vui lòng nhập mô tả !">(*)</asp:RequiredFieldValidator>
            </div>
        </div>
        <div class="form-group">
